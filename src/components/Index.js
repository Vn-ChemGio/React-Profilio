                            ...
                            <div className="blog-post image-left">
                                <div className="inner">
                                    ...
                                    <div className="content">
                                        ...
                                        <footer>
                                            <span className="comments-link"><a
                                                href="single-blog-post.html">3 Comments</a></span>
                            ...
                            <div className="blog-post">
                                <div className="inner">
                                    <div className="content">
                                        ...
                                        <footer>
                                            <span className="comments-link"><a
                                                href="single-blog-post.html">7 Comments</a></span>
                                            <span className="share-link"><a href="single-blog-post.html"><i
                                                className="fa fa-share-alt"/></a></span>
                                        </footer>
                                    </div>
                            ...
                            <div className="blog-post image-top">
                                <div className="inner">
                                    ...
                                    <div className="content">
                                        ...
                                        <footer>
                                            <span className="comments-link"><a
                                                href="single-blog-post.html">4 Comments</a></span>
                                            <span className="share-link"><a href="single-blog-post.html"><i
                                                className="fa fa-share-alt"/></a></span>
                                        </footer>
                                    </div>
                            ...
                            <div className="blog-post image-top">
                                <div className="inner">
                                    ...
                                    <div className="content">
                                        ...
                                        <footer>
                                            <span className="comments-link"><a
                                                href="single-blog-post.html">10 Comments</a></span>
                                            <span className="share-link"><a href="single-blog-post.html"><i
                                                className="fa fa-share-alt"/></a></span>
                                        </footer>
                                    </div>
                            ...
                            <div className="blog-post image-right">
                                <div className="inner">
                                    ...
                                    <div className="content">
                                        ...
                                        <footer>
                                            <span className="comments-link"><a
                                                href="single-blog-post.html">5 Comments</a></span>
                                            <span className="share-link"><a href="single-blog-post.html"><i
                                                className="fa fa-share-alt"/></a></span>
                                        </footer>
                                    </div>
                            ...
                            <div className="blog-post image-left">
                                <div className="inner">
                                    ...
                                    <div className="content">
                                        ...
                                        <footer>
                                            <span className="comments-link"><a
                                                href="single-blog-post.html">6 Comments</a></span>
                                            <span className="share-link"><a href="single-blog-post.html"><i
                                                className="fa fa-share-alt"/></a></span>
                                        </footer>
                                    </div>
